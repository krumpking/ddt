...
import { LIGHT_GRAY, PRIMARY_COLOR, TEMPLATES } from '../app/constants/constants';
import Loader from '../app/components/loader';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
import { useRouter } from 'next/router'
import ClientNav from '../app/components/clientNav';
import { IForm } from '../app/types/type';
...
const Home = () => {
    ...
    const [numberOfForms, setNumberOfForms] = useState(10);
    const [numberOfDevices, setNumberOfDevices] = useState(5);
    const [diskSpaceUsed, setDiskSpaceUsed] = useState(0.1);
                ...
                <div className='bg-white col-span-8 m-8 rounded-[30px] flex flex-col p-8'>
                    ...
                    <div className='grid grid-cols-5 gap-4'>
                        ...
                        <div className='col-span-2 flex flex-col space-y-4'>
                            ...
                            <DataSummary description={'Number of devices connected'} num={numberOfDevices} />
