...
const Drawer: FC<MyProps> = ({ children, isOpen, setIsOpen }) => {
    return (
        ...
        >
            ...
            >
                <article className="relative w-screen max-w-lg pb-10 flex flex-col space-y-6 overflow-y-scroll h-full bg-[#00947a] rounded-[30px] items-center shadow-md px-8">
                    {children}
                </article>
            </section>
            <section
