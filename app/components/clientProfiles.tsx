...
import { getAllClientsToDB, updateClientToDB } from '../api/crmApi';
...
const ClientProfile = () => {
    ...
    const updateStage = () => {
        ...
        if (typeof editMember !== 'undefined') {
            ...
            notesA.push(encrypt(editMember.notes, id));
            var prodA: any = [];
            if (editMember.enquired.includes(",")) {
                var prodAr = editMember.enquired.split(",");
            ...
            var client = {
                ...
                enquired: prodA,
                value: encrypt(editMember.totalAmount, id),
                encryption: 2
            }
            ...
            {loading ?
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='grid grid-cols-2 p-4'>
                        <div>
                            <p className='text-base'>Total Number of clients {clients.length}</p>
                        </div>
                    </div>
